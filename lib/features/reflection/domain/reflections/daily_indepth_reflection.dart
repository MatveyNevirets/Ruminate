    ...
    final steps = [
      ...
      ReflectionStepModel(
        ...
        questionsAndAnswers: [
          ...
          {"Вспомни, что тебя больше всего зарядило, дало ресурс?": null},
          {
            "Вспомни, что для тебя сегодня являлось 'энергетическим вампиром'?":
                null,
          },
      ...
      ReflectionStepModel(
        title: "Напиши 3 самые главные победы дня",
        description: "",
        questionsAndAnswers: [
          {"Победа 1": null},
          {"Победа 2": null},
