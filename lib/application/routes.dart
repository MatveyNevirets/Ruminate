...
import 'package:ruminate/features/start_screen/presentation/start_screen.dart';

final firstStartConfigRouter = GoRouter(
  initialLocation: "/welcome",
  routes: [
    GoRoute(
      path: "/welcome",
      builder: (context, state) {
        return WelcomeScreen([true, false]);
      },
      routes: [
        GoRoute(
          path: "/before_start",
